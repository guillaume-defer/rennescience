...
export const API_ENDPOINTS: APIEndpointConfig[] = [
  ...
  },
  {
    ...
    category: 'transport',
    baseUrl: API_CONFIG.STAR.BASE_URL,
    endpoint: `${API_CONFIG.STAR.BUS_POSITIONS_REALTIME}/records?limit=100`,
    method: 'GET',
    requiresAuth: false,
    timeout: 10000,
    retryCount: 2,
  ...
  },
  {
    ...
    category: 'transport',
    baseUrl: API_CONFIG.STAR.BASE_URL,
    endpoint: `${API_CONFIG.STAR.BUS_NEXT_DEPARTURES}/records?limit=100`,
    method: 'GET',
    requiresAuth: false,
    timeout: 10000,
    retryCount: 2,
  ...
  },
  {
    ...
    category: 'transport',
    baseUrl: API_CONFIG.STAR.BASE_URL,
    endpoint: `${API_CONFIG.STAR.BUS_LINES_TOPOLOGY}/records?limit=100`,
    method: 'GET',
    requiresAuth: false,
    timeout: 15000,
    retryCount: 3,
